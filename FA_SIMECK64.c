...
void getK1(uint32_t cipher[2], uint32_t constant, uint64_t seq, uint32_t keys[4]);
void getMasterkey(uint32_t cipher[2], uint32_t constant, uint64_t seq, uint32_t keys[4]);

const int NUM_ROUNDS = 44;    
const int8_t WORD_SIZE = 32;    
